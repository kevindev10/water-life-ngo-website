  ...
  return (
    <div className=" ">
       <div>
		 ...
		 <div className=' pb0 tc' >
        	 <h1 className='f1 black fw8  ' >GET IN TOUCH</h1>
        	 
    	  </div>

    	  <div>
    	  	 <div className='ph6 mh6 partner-form-on-mobile'>
					    <form action="https://formsubmit.co/Kevozzz@yahoo.com" method="POST">
					    	<h1 className='gray'>Email us !</h1>
					    	<div class="col">
						    	 <input type="text" name="name" required placeholder='Full Name' className='ml0 form-control ma2 pa2 w-80 f3 br1 shadow-5 '/>
						    </div>
						    <div className="col">	 
						     <input type="email" name="email" required placeholder='Email Address' className='ml0 form-control ma2 pa2 w-100 f3 br1 shadow-5 '/>
							</div>
							<div className="col">
						     <input type="text" name="phone" required placeholder='Phone Number' className='ml0 form-control ma2 pa2 w-80 f3 br1 shadow-5 '/>
						    </div>
						    <div className="col">
						     <input type="text" name="subject" required placeholder='Subject' className='ml0 form-control ma2 pa2 w-80 f3 br1 shadow-5' />
						    </div> 
						    <div className="form-group">
					            <textarea placeholder="Your Message " className="ml0 form-control ma3 pa3 w-80 f3 br1 shadow-5 " name="message" rows="8" required></textarea>
					        </div>

					        <div className='mv2 pv4'>

						     	<p className='ml0 mb4'>Add me to Water life's email list</p>
								<label className="container ma2 pa2">
						     ...
						     <button type="submit" className='btn btn-lg btn-dark btn-block ml0 ma2 pa2 w-60 br1 shadow-5 f3 dib '>Send</button>
