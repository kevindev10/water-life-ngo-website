    ...
    <div className="tc  ">
        <div>
		 ...
		 <div className=' pb4 tc' >
        	 <h1 className='f1 black fw8  ' >WHO WE ARE</h1>
        	
    	  </div>
		
		<div className='  ' >
			<h2 className='mb4 f2 main-heading-mobile'>OUR MISSION</h2>
			<p className='mb4 gray f3 ph2 sub-heading-mobile'>Water Life is dedicated to alleviating water poverty to bring hope to communities in The Central African Republic. </p>

			<h2 className='mb4 f2 main-heading-mobile'>VISION</h2>
			<p className='mb4 gray f3 ph2 sub-heading-mobile '>We are dedicated to the vision of a world without water poverty.</p>

			<h2 className='mb4 f2 main-heading-mobile'>ABOUT US</h2>
			<p className='mb3 gray f3 ph3 sub-heading-mobile'>Water Life collaborates with a network of organizations to develop and
			 implement clean water projects that vary depending on the needs of each individual
			 community we serve. These include wells, water purification systems, hand pump repair,
			 and conducting health education programs. </p>
			<p className='mb4 gray f3 ph3 sub-heading-mobile'>As Water Life is an organization founded upon Christian values,
			 we often work with mission-based organizations in the field. We do not, however,
			 use donations for religious purposes.</p>
		...
		<div>
			<h2 className='mb4 f2 main-heading-mobile '>OUR VALUES</h2>
			<ul >
				<li className='mb4 gray f3 ph3 sub-heading-mobile'>Providing long term and sustainable water solutions.</li>
				<li className='mb4 gray f3 ph3 sub-heading-mobile '>Matching each community to the most appropriate clean water technology.</li>
				<li className='mb4 gray f3 ph3 sub-heading-mobile '>Empowering local communities by including them in every decision process.</li>
				<li className='mb4 gray f3 ph3 sub-heading-mobile '>Transparency with partners, donors, volunteers, and staff.</li>
				<li className='mb4 gray f3 ph3 sub-heading-mobile '>A Holistic Approach: empowering and always working with in-country partners who do so much more than water.</li>
				<li className='mb4 gray f3 ph3 sub-heading-mobile'>Striving to ensure the most of every dollar goes towards providing clean water.</li>
				<li className='mb4 gray f3 ph3 sub-heading-mobile '>And what does the Lord require of you? To act justly, love mercy, and walk humbly with your God" - Micah 6:8.</li>
