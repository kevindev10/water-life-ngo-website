    ...
    <div className=" ">
       <div>
		 ...
		 <div className=' pb4 tc' >
        	 <h1 className='f1 black fw8  ' >OUR PARTNERS</h1>
        	 <p className='f3 white fw8 bg-orange w-90 center '  >Our work would not be possible without our amazing partners.</p>
    	  </div>
    	  
    	  <div className='tc ma4 ph2'>
    	  	<h4 className='pb3 f3 main-heading-mobile'>PARTNERS</h4>
    	  	<p className='f4 paragraph-mobile'>Water Life knows that building long-term,
    	  	 trustworthy partnerships is absolutely crucial to the success
    	  	 of our efforts to combat global water poverty. Only by working 
    	  	 together with organizations with strong roots in both the United
    	  	 States and in partner countries can we develop the relationships 
    	  ...
    	  <div className='ph5 mh5 pv2 partner-form-on-mobile'>
			  ...
			  <form action="action_page.php">
			    ...
			    <label for="oname">Orgainzation Name</label>
			    <input type="text" id="oname" name="organizationname" placeholder="Your organization name.."/>
			    ...
			    <textarea id="subject" name="subject" placeholder="Tell us why you are interested in working with Water Life" style={{"height":"200px"}}></textarea>
